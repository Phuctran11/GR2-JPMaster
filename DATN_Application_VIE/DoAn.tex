...
\IfFileExists{lstlisting.tex}{\input{lstlisting.tex}}{} % Phần này cho phép chèn code và formatting code như C, C++, Python
...
\def \TITLE{Thiết kế và phát triển nền tảng học tiếng Nhật trực tuyến JPMaster tích hợp trợ lý AI và luyện thi JLPT}
\def \AUTHOR{TRẦN CAO BẢO PHÚC}
...
\graphicspath{{Hinhve/}{../Hinhve/}{figures/}{../figures/}} % Thư mục chứa các hình ảnh
...
\subfile{Chuong/5_Ket_qua_danh_gia}
...
%     {}         % unnumbered format
%     {\titlerule*[0.3pc]{.}\contentspage}         % filler-page-format, e.g dots
% \chapter{CẤU HÌNH MÔI TRƯỜNG VÀ CƠ SỞ DỮ LIỆU}
% \subfile{Chuong/Phu_luc_A}
% \newpage
% \chapter{HƯỚNG DẪN KHỞI CHẠY VÀ TÀI KHOẢN KIỂM THỬ}
