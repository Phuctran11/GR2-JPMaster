          ...
          {visibleCourses.map((enrollment) => {
            ...
            return (
              <div key={enrollment.enrollment_id}>
                ...
                <div className="h-3 rounded-full bg-surface-container-low shadow-inner ring-1 ring-outline-variant/50">
                  <div
                    className="h-full rounded-full bg-gradient-to-r from-primary via-secondary to-success shadow-sm shadow-primary/25"
