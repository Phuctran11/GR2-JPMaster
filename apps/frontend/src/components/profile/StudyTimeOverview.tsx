    ...
    <div className="rounded-xl border border-outline-variant bg-surface p-4 shadow-sm">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-[1.1fr_0.9fr_0.9fr]">
        ...
        <div className="rounded-lg border border-[#20b486]/25 bg-[#eafaf4] p-4">
          ...
          <div className="mt-3 h-2.5 rounded-full bg-white/80 shadow-inner ring-1 ring-emerald-700/10">
            <div className="h-full rounded-full bg-gradient-to-r from-[#20b486] to-[#73d13d] shadow-sm shadow-emerald-500/25 transition-all" style={{ width: `${weekPercent}%` }} />
          </div>
        ...
        <div className="rounded-lg border border-[#7c3aed]/20 bg-[#f4efff] p-4">
          ...
          <div className="mt-3 h-2.5 rounded-full bg-white/80 shadow-inner ring-1 ring-sky-700/10">
            <div className="h-full rounded-full bg-gradient-to-r from-[#7c3aed] to-[#38bdf8] shadow-sm shadow-sky-500/25 transition-all" style={{ width: `${monthPercent}%` }} />
          </div>
