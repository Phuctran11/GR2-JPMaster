...
import { Card, ImageCard, CategoryBadge, InteractiveHoverCard } from '../ui';
...
export function BlogCard({ title, category, date, image, excerpt, link }: BlogCardProps) {
  ...
  return (
    <InteractiveHoverCard className="group h-full rounded-xl" tone="secondary">
      <Card className="bg-surface border border-outline-variant rounded-xl overflow-hidden transition-all duration-300 flex h-full flex-col hover:border-primary/35">
...
export function FeaturedBlogCard({
  ...
  return (
    <InteractiveHoverCard className="group h-full rounded-xl" tone="primary">
      <article className="bg-surface border border-primary/25 rounded-xl overflow-hidden flex h-full flex-col transition-all duration-300 hover:border-primary/50">
